...
👤 Émilie, 21 ans
🧑‍💼 Jeune active en premier CDI
🪪 Profil & contexte

- 21 ans, première expérience professionnelle après ses études
- Vit en location dans une grande ville
- Salaire modeste (premier CDI) et charges étalées dans le mois
- Pas d’éducation financière : a toujours “fait au feeling”
- Gère seule son budget, sans vraie méthode

🎯 OBJECTIFS : 

- Ne plus être à découvert en fin de mois
- Comprendre simplement son reste-à-vivre, sans calcul mental
- Trouver un outil clair, rapide et utilisable mobile-first
- Prendre de meilleures décisions financières, sans stress

😣 FRUSTRATIONS :

- Peur du découvert, mais ne sait pas comment l’anticiper
- Les applications bancaires sont trop complexes et peu adaptées à sa réalité
- Difficulté avec les chiffres, les tableaux, les calculs
- Impression que son argent “s’évapore”
- Ne comprend pas toujours l’impact de ses dépenses

🔄 COMPORTEMENTS ACTUELS :

- Télécharge parfois des apps de budget… mais abandonne rapidement
- Achète des choses sans vérifier son budget (sans contact, 4×, promo Insta…)
- Oublie de noter ses dépenses
- Est sensible aux achats émotionnels, notamment après une journée difficile
- Vérifie son solde, mais pas les dépenses à venir

💛 BESOINS PROFONDS :

- Une interface simple, qui calcule automatiquement le reste-à-vivre
- Une méthode qui ne repose pas sur les chiffres uniquement
- Un outil qui l’aide à comprendre ses émotions avant d’acheter
- Un repère clair : possible / risqué / impossible
- Une prise de conscience du lien entre stress / ennui / réconfort et ses décisions financières

🗣️ Citation clé :

« J’ai l’impression que mon argent disparaît sans que je comprenne comment. »

🎓 Pourquoi ce persona est crucial pour BalanceMe ?

- Il représente la majorité des jeunes utilisateurs vulnérables
- Il justifie ton approche “budget + émotion”
- Il aligne parfaitement les fonctionnalités avec un vrai besoin social
